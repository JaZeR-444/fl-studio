    ...
    <div className="min-h-screen bg-[var(--bg-app)] text-white overflow-hidden relative">
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 pt-20 pb-12">
        <div className="max-w-5xl mx-auto text-center animate-fade-in-up">
          {/* Badge */}
          <Badge variant="premium" className="mb-6 text-sm py-2 px-4 shadow-[0_0_30px_rgba(255,165,0,0.3)]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link 
              href="/hub" 
              className="group relative px-8 py-4 bg-gradient-to-r from-[var(--primary)] to-orange-500 hover:from-[var(--primary-light)] hover:to-orange-400 text-white font-bold text-lg rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-[0_0_50px_rgba(255,165,0,0.4)] flex items-center justify-center gap-3 overflow-hidden"
            >
      ...
      <section className="relative z-10 py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Card 4 - Learning */}
            <Link href="/hub#quick-start" className="group relative p-6 rounded-2xl bg-gradient-to-br from-orange-500/10 to-orange-500/5 border border-orange-500/20 hover:border-orange-500/40 transition-all hover:scale-[1.02]">
              <div className="absolute top-4 right-4">
                <span className="text-xs font-medium text-orange-400 bg-orange-500/20 px-2 py-1 rounded-full">New</span>
              </div>
              ...
              <h3 className="text-xl font-bold text-white mb-2 group-hover:text-orange-400 transition-colors">Quick Start Guides</h3>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-[var(--primary)]/20 border-2 border-[var(--primary)] flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-black text-[var(--primary)]">1</span>
              </div>
      ...
      {/* ===== FINAL CTA ===== */}
      <section className="relative z-10 py-20 px-4 bg-gradient-to-t from-[var(--primary)]/10 to-transparent">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link 
            href="/hub" 
            className="inline-flex items-center gap-3 px-10 py-4 bg-[var(--primary)] hover:bg-[var(--primary-light)] text-white font-bold text-lg rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-[0_0_50px_rgba(255,165,0,0.4)]"
          >
            <span>Enter the Hub</span>
