# SVF Filter Topology (SimSynth)

SimSynth uses a state-variable filter with mix controls for LP, BP, and HP outputs.

- LP adds body and smoothness.
- BP adds nasal focus.
- HP removes lows for bright leads.

## Practical Use
- Bass: LP high, BP/HP low.
- Pads: blend LP and BP.
- Leads: increase HP slightly for clarity.
