...
Goal: Reliable bass patch template

---

## Steps
1. LP24 filter, low cutoff.
2. Sub oscillator at moderate level, phase tuned for punch.
3. Low resonance for stable bass.
4. No unison or minimal unison.

## Notes
- Add distortion externally if the bass needs more edge.
