# Legacy Presets Guide (SimSynth)

## What to Capture
- Oscillator shapes and Warm status.
- SVF mix (LP/BP/HP balance).
- LFO destination and rate.
- Chorus amount for width.

## Why It Matters
Preset documentation makes it easier to recreate classic 80s tones and compare them against modern synths.
