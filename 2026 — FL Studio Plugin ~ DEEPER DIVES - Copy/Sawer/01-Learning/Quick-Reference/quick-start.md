...
## Goal
Create a solid, aggressive bass patch in under 10 minutes.

## Steps
1. Set filter to LP24.
2. Use main saw + sub oscillator at moderate level.
3. Raise resonance until the tone gains bite.
4. Set amp envelope: fast attack, short decay, medium sustain.
5. Add slight filter envelope for movement.
6. Keep unison off or minimal for bass clarity.

## Expected Result
A punchy, focused bass with Polivoks-style grit.
