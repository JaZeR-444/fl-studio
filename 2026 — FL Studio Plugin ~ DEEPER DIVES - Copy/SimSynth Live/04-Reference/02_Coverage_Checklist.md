# Coverage Checklist - SimSynth Live
...
- [x] filter-topology.md

## Quick Reference
- [x] 02_Best_Settings_Starting_Points.md (Pending, but planned in workflows)
...
## Workflows
- [x] classic-subtractive-bass.md
- [x] creating-thick-strings.md
- [x] 80s-pop-brass.md
- [x] 10_Vibe_Moody.md
- [x] 11_Vibe_Upbeat.md
