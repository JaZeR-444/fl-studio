# Polivoks Character (Sawer)

## Summary
Sawer models the Polivoks filter response: aggressive resonance, midrange growl, and unstable edge. This makes it ideal for acid-like basses and screaming leads.

## What to Listen For
- Resonance saturates quickly and can self-oscillate.
- LP modes emphasize a gritty midrange.
- Sub oscillator phase changes low-end punch and hollowness.

## Design Guidance
- Bass: keep resonance moderate, use LP24.
- Leads: raise resonance, add sync and phaser.
- Texture: add a touch of noise and modulate cutoff with LFO.
